...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 530.0, 214.0, 81.0, 22.0 ],
					"text" : "numpoints 95"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 279.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 446.0, 214.0, 77.0, 22.0 ],
					"text" : "definepoint 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 326.0, 214.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 214.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 201.0, 92.0, 52.0, 22.0 ],
					"text" : "t b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 119.0, 164.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 128.5, 199.0, 215.5, 199.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 221.5, 199.0, 335.5, 199.0 ],
					"source" : [ "obj-33", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 232.5, 199.0, 455.5, 199.0 ],
					"source" : [ "obj-33", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 243.5, 199.0, 539.5, 199.0 ],
					"source" : [ "obj-33", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 335.5, 265.0, 215.5, 265.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 539.5, 265.0, 215.5, 265.0 ],
					"source" : [ "obj-44", 0 ]
				}
